...
export default function CircleImage({ className, imageUrl, text, onClick }: CircleImageProps) {
  return (
    ...
    <div className={`flex items-center justify-center ${className}`} onClick={onClick}>
      <div className="relative flex size-[120px] items-center justify-center rounded-full bg-gray-200 md:size-[140px]">
        <Image src={imageUrl} alt="profile" className="size-[120px] rounded-full md:size-[140px]" />
